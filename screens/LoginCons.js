...
export default ({ navigation }) => {
    ...
    const handleLogin = async () => {
        try {
            ...
            const response = await axios.get('http://192.168.1.6:8000/api/v1/consumer/login', requestData);
...
//         try {
//             const response = await axios.get('http://192.168.1.6:8000/api/v1/consumer/sendOtp', {
//                 params: { phoneNumber }
//             });
//             if (response.status === 200) {
//                 setIsOtpSent(true);
...
//     const handleLogin = async () => {
//         try {
//             const response = await axios.get('http://192.168.1.6:8000/api/v1/consumer/login', {
...
//     const handleSendOtp = async () => {
//         try {
//             const response = await axios.get('http://localhost:8000/api/v1/consumer/sendOtp', {
//                 params: { phoneNumber }
//             });
//             if (response.status === 200) {
//                 setIsOtpSent(true);
...
//     const handleLogin = async () => {
//         try {
//             const response = await axios.get('http://localhost:8000/api/v1/consumer/login', {
//                 params: { phoneNumber, otp }
//             });
//             if (response.status === 200) {
//                 Alert.alert('Success', 'Login successful');
...
//     const handleSendOtp = async () => {
//         try {
//             const response = await axios.post('http://localhost:8000/api/v1/consumer/sendOtp', { phoneNumber });
//             if (response.status === 200) {
//                 setIsOtpSent(true);
//                 Alert.alert('Success', 'OTP sent successfully');
//             }
...
//     const handleLogin = async () => {
//         try {
//             const response = await axios.post('http://localhost:8000/api/v1/consumer/login', { phoneNumber, otp });
//             if (response.status === 200) {
//                 Alert.alert('Success', 'Login successful');
//                 navigation.navigate('HomePreKyc');
//             }
