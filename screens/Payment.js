...
const CheckoutButton = () => {
  ...
  const checkoutHandler = async () => {
    try {
      ...
      // Create order
      const { data: { order } } = await axios.post("http://192.168.1.6:8000/api/v1/visitor/placeOrder", { amount: formData.amount });
      ...
      if (RazorpayCheckout) {
        ...
        console.error("RazorpayCheckout is not initialized properly.");
...
//       // Create order
//       const { data: { order } } = await axios.post("http://192.168.1.6:8000/api/v1/visitor/placeOrder", { amount });
//       console.log("Order ID:", order.id);
//       console.log("Order Amount:", order.amount);
...
//     try {
//       const response = await fetch('http://192.168.1.6:8000/api/v1/visitor/placeOrder', {
//         method: 'POST',
//         headers: {
...
//     try {
//       const response = await fetch(`http://192.168.1.6:8000/api/v1/visitor/verifyPayment`, {
//         method: 'POST',
//         headers: {
//           'Content-Type': 'application/json'
//         },
...
//     const handlePlaceOrder = async () => {
//         try {
//             const response = await fetch('http://localhost:8000/api/v1/visitor/placeOrder', {
//                 method: 'POST',
//                 headers: {
//                     'Content-Type': 'application/json'
//                 },
...
//     const handleVerifyPayment = async (orderId) => {
//         try {
//             const response = await fetch(`http://localhost:8000/api/v1/visitor/verifyPayment`, {
//                 method: 'POST',
//                 headers: {
//                     'Content-Type': 'application/json'
//                 },
